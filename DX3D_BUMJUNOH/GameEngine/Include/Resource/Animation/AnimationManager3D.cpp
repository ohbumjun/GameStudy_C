...
bool CAnimationManager3D::LoadSkeleton(const std::string& Name, const TCHAR* FileName, const std::string& PathName,
	CScene* Scene)
{
...
bool CAnimationManager3D::LoadSkeletonMultibyte(const std::string& Name, const char* FileName,
