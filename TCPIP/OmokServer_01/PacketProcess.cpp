...
namespace NLogicLib
{
	...
	NCommon::ERROR_CODE PacketProcess::LobbyList(PacketInfo packetInfo)
	{
		return NCommon::ERROR_CODE();
	}

	NCommon::ERROR_CODE PacketProcess::LobbyEnter(PacketInfo packetInfo)
	{
		return NCommon::ERROR_CODE();
	}

	NCommon::ERROR_CODE PacketProcess::LobbyLeave(PacketInfo packetInfo)
	{
		return NCommon::ERROR_CODE();
	}
	...
	NCommon::ERROR_CODE PacketProcess::RoomLeave(PacketInfo packetInfo)
	{
		return NCommon::ERROR_CODE();
	}

	NCommon::ERROR_CODE PacketProcess::RoomChat(PacketInfo packetInfo)
	{
		return NCommon::ERROR_CODE();
	}

	NCommon::ERROR_CODE PacketProcess::RoomMasterGameStart(PacketInfo packetInfo)
	{
		return NCommon::ERROR_CODE();
	}

	NCommon::ERROR_CODE PacketProcess::RoomGameStart(PacketInfo packetInfo)
	{
		return NCommon::ERROR_CODE();
	}

	NCommon::ERROR_CODE PacketProcess::DevEcho(PacketInfo packetInfo)
	{
		return NCommon::ERROR_CODE();
	}
